...
export const AboutSection: React.FC<AboutSectionProps> = ({ lang }) => {
  return (
    <section id="tentang" className="py-20 lg:py-28 bg-slate-900/40 relative border-t border-slate-800/80">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-b from-slate-950 via-[#060c26] to-slate-950 border border-slate-800/80 rounded-3xl p-6 sm:p-10 shadow-2xl shadow-cyan-950/20 mb-16 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-14 relative z-10">
            ...
            <div className="space-y-3.5">
              ...
              <p className="text-slate-300 text-xs sm:text-sm lg:text-[15px] leading-relaxed text-justify sm:text-left">
          ...
          <div className="mt-10 pt-6 border-t border-slate-800/80 grid grid-cols-2 sm:grid-cols-4 gap-3.5 text-xs relative z-10">
            <div className="bg-slate-900/80 border border-slate-800/80 p-3 rounded-xl text-center">
              <div className="text-cyan-400 font-bold text-sm">ICT &amp; ME</div>
              <div className="text-slate-400 text-xs mt-0.5">Integrasi Sistem Penuh</div>
            </div>
            <div className="bg-slate-900/80 border border-slate-800/80 p-3 rounded-xl text-center">
              <div className="text-orange-400 font-bold text-sm">Prinsipal Resmi</div>
              <div className="text-slate-400 text-xs mt-0.5">Garansi &amp; Lisensi Sah</div>
            </div>
            <div className="bg-slate-900/80 border border-slate-800/80 p-3 rounded-xl text-center">
              <div className="text-cyan-400 font-bold text-sm">Respon Cepat</div>
              <div className="text-slate-400 text-xs mt-0.5">Layanan &amp; SLA Andal</div>
            </div>
            <div className="bg-slate-900/80 border border-slate-800/80 p-3 rounded-xl text-center">
              <div className="text-orange-400 font-bold text-sm">Profesional</div>
              <div className="text-slate-400 text-xs mt-0.5">Berpengalaman &amp; Teruji</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {/* Vision Card */}
          <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 hover:border-cyan-500/40 transition-all rounded-2xl p-6 sm:p-8 relative group">
            ...
            <ul className="space-y-3 pl-1 text-sm text-slate-300">
              {COMPANY_INFO.mission.map((item, index) => (
                <li key={index} className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-5 h-5 rounded-full bg-slate-800 border border-cyan-500/30 text-cyan-400 text-[11px] font-bold flex items-center justify-center mt-0.5">
                    {index + 1}
                  </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-slate-900/60 border border-slate-800/80 p-5 rounded-xl hover:border-slate-700 transition-colors">
