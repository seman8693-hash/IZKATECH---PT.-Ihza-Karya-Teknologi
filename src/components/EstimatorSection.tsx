...
Dikirim melalui Form Website IZKATECH (www.izkatech.com)`;
  ...
  return (
    <section id="kalkulator" className="py-20 lg:py-28 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Left Form (7 cols) */}
          <div className="lg:col-span-7 bg-white/90 border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-6 shadow-xl">
                  ...
                  return (
                    <button
                      ...
                      className={`text-left p-3 rounded-xl border text-xs font-medium transition-all flex items-start gap-2.5 cursor-pointer ${
                        isChecked
                          ? 'bg-cyan-950/60 border-cyan-500/60 text-cyan-700 shadow-sm'
                          : 'bg-white/75 border-slate-200/90 text-slate-500 hover:text-slate-800 hover:bg-white'
                      }`}
                    >
                      <div className={`mt-0.5 w-4 h-4 rounded flex items-center justify-center flex-shrink-0 transition-colors ${
                        isChecked ? 'bg-cyan-500 text-slate-950' : 'border border-slate-200'
                      }`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-white border border-slate-200/80 rounded-xl px-3 py-2.5 text-xs sm:text-sm text-slate-800 focus:outline-none focus:border-cyan-400"
                >
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <input
                  ...
                  className="w-full bg-white border border-slate-200/80 rounded-xl px-3 py-2 text-xs sm:text-sm text-slate-800 placeholder:text-slate-500 focus:outline-none focus:border-cyan-400"
                />
                <input
                  type="text"
                  value={clientName}
              ...
              <textarea
                ...
                className="w-full bg-white border border-slate-200/80 rounded-xl px-3 py-2 text-xs sm:text-sm text-slate-800 placeholder:text-slate-500 focus:outline-none focus:border-cyan-400 resize-none"
              />
            </div>
          ...
          <div className="lg:col-span-5 bg-gradient-to-br from-slate-100 to-slate-100 border border-cyan-500/30 rounded-2xl p-6 sm:p-7 space-y-5 shadow-2xl relative">
            <div className="flex items-center justify-between border-b border-slate-200 pb-4">
              ...
              <button
                onClick={handleCopy}
                className="inline-flex items-center gap-1.5 text-xs text-slate-500 hover:text-white px-2.5 py-1 rounded bg-slate-100 border border-slate-200 hover:border-cyan-500 transition-colors cursor-pointer"
              >
            ...
            <div className="bg-white/90 rounded-xl p-4 border border-slate-200 font-mono text-[11px] leading-relaxed text-slate-600 whitespace-pre-wrap max-h-72 overflow-y-auto">
              {generateSummaryText()}
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-semibold text-xs sm:text-sm text-slate-800 bg-slate-850 hover:bg-slate-100 border border-slate-200 transition-colors cursor-pointer"
              >
            ...
            {submittedMessage && (
              <div className="p-3 rounded-xl bg-emerald-950/80 border border-emerald-700/80 text-emerald-700 text-xs flex items-center gap-2 animate-fadeIn">
