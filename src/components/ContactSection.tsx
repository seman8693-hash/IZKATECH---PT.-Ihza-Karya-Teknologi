...
export const ContactSection: React.FC<ContactSectionProps> = ({ lang }) => {
  ...
  return (
    <section id="kontak" className="py-20 lg:py-28 bg-white/75 border-t border-slate-200 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            {/* Office Address Card */}
            <div className="bg-white/90 border border-slate-200 rounded-2xl p-6 text-left hover:border-cyan-500/40 transition-colors">
              ...
              <div className="mt-4 pt-3 border-t border-slate-200/80 flex items-center justify-between text-xs">
                <span className="text-slate-500">Bandung, Indonesia</span>
                <a
            ...
            <div className="bg-white/90 border border-slate-200 rounded-2xl p-6 text-left hover:border-cyan-500/40 transition-colors">
              ...
              <div className="space-y-2 text-sm text-slate-600 pl-1">
                <div className="flex items-center justify-between">
                  <span className="text-slate-500 text-xs">Telepon Kantor (Landline):</span>
                  <a href="tel:02263729430" className="font-semibold text-white hover:text-cyan-600 font-mono">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer" 
                    className="font-semibold text-emerald-600 hover:text-emerald-700 font-mono"
                  >
            ...
            <div className="bg-white/90 border border-slate-200 rounded-2xl p-6 text-left hover:border-cyan-500/40 transition-colors">
              ...
              <div className="space-y-2 text-sm text-slate-600 pl-1">
                <div className="flex items-center justify-between">
                  <span className="text-slate-500 text-xs">Email Resmi:</span>
                  <a href={`mailto:${COMPANY_INFO.email}`} className="font-semibold text-cyan-600 hover:underline">
                    {COMPANY_INFO.email}
                  </a>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-500 text-xs">Website Portal:</span>
                  <a href="https://www.izkatech.com" className="font-semibold text-white hover:text-cyan-600">
            ...
            {/* Operational Hours */}
            <div className="bg-white/65 border border-slate-200/80 rounded-xl p-4 flex items-center gap-3 text-xs text-slate-500">
            ...
            <div className="bg-white/90 border border-slate-200 rounded-2xl p-5 text-left space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono text-cyan-600">@izkatech</span>
              </div>
              <div className="grid grid-cols-3 gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center justify-center p-3 rounded-xl bg-white border border-slate-200 hover:border-blue-500 hover:bg-blue-600/10 text-slate-600 hover:text-white transition-all group cursor-pointer"
                >
                  <FacebookIcon className="w-5 h-5 text-blue-600 group-hover:scale-110 transition-transform mb-1.5" />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center justify-center p-3 rounded-xl bg-white border border-slate-200 hover:border-pink-500 hover:bg-pink-600/10 text-slate-600 hover:text-white transition-all group cursor-pointer"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center justify-center p-3 rounded-xl bg-white border border-slate-200 hover:border-cyan-400 hover:bg-cyan-500/10 text-slate-600 hover:text-white transition-all group cursor-pointer"
                >
                  <TikTokIcon className="w-5 h-5 text-cyan-700 group-hover:scale-110 transition-transform mb-1.5" />
          ...
          <div className="lg:col-span-7 bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 text-left shadow-2xl">
            <div className="mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-cyan-400"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-600 mb-1.5">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-cyan-400 resize-none"
                />
              </div>
              ...
              {submitted && (
                <div className="p-3.5 rounded-xl bg-emerald-950/80 border border-emerald-700 text-emerald-700 text-xs flex items-center gap-2.5">
