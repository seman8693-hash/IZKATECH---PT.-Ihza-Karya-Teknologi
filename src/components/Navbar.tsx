  ...
  return (
    <header 
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled 
          ? 'bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-2xl py-2.5' 
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
        ...
        <nav className="hidden xl:flex items-center gap-1 xl:gap-1.5 shrink-0">
          {navLinks.map((link) => (
            <a
              ...
              className="px-2.5 xl:px-3 py-1.5 text-xs xl:text-sm font-medium text-slate-600 hover:text-cyan-600 hover:bg-white/80 rounded-lg transition-colors whitespace-nowrap"
            >
        ...
        <div className="hidden sm:flex items-center gap-2.5 shrink-0">
          ...
          <div className="hidden lg:flex items-center gap-1 bg-white/85 border border-slate-200/90 rounded-lg px-1.5 py-1">
            <a
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-1 text-slate-500 hover:text-pink-400 hover:bg-slate-100 rounded transition-colors"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-1 text-slate-500 hover:text-cyan-700 hover:bg-slate-100 rounded transition-colors"
          ...
          {/* Language Toggle */}
          <div className="flex items-center bg-white/90 border border-slate-200 rounded-lg p-0.5 text-xs font-semibold shrink-0">
            <button
              id="lang-btn-id"
              onClick={() => setLang('id')}
          ...
          {onOpenSlideDeck && (
            <button
              ...
              className="hidden 2xl:inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-cyan-700 bg-orange-950/30 hover:bg-orange-900/50 border border-cyan-500/50 rounded-lg transition-colors cursor-pointer shadow-sm whitespace-nowrap shrink-0"
          ...
          {onOpenLiveChat && (
            <button
              ...
              className="relative hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-semibold text-slate-600 bg-white/90 hover:text-cyan-700 hover:border-cyan-500/50 hover:bg-slate-100 border border-slate-200 rounded-lg transition-all cursor-pointer whitespace-nowrap shrink-0"
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-semibold text-slate-600 bg-white/90 hover:text-cyan-700 hover:border-cyan-500/50 hover:bg-slate-100 border border-slate-200 rounded-lg transition-all cursor-pointer whitespace-nowrap shrink-0"
          ...
          <button
            ...
            className="hidden lg:inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-800 bg-white hover:bg-slate-100 border border-slate-200/80 rounded-lg transition-colors cursor-pointer whitespace-nowrap shrink-0"
          >
        ...
        <div className="flex items-center gap-2 xl:hidden">
          <div className="flex items-center bg-white border border-slate-200 rounded-lg p-0.5 text-xs font-medium sm:hidden">
            <button
              onClick={() => setLang('id')}
              className={`px-2 py-1 rounded ${lang === 'id' ? 'bg-cyan-500 text-slate-950 font-bold' : 'text-slate-500'}`}
            >
              ID
            </button>
            <button
              onClick={() => setLang('en')}
              className={`px-2 py-1 rounded ${lang === 'en' ? 'bg-cyan-500 text-slate-950 font-bold' : 'text-slate-500'}`}
            >
              EN
            </button>
          </div>
          <button
            ...
            className="p-2 text-slate-600 hover:text-white hover:bg-white rounded-lg border border-slate-200"
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div id="mobile-menu-drawer" className="xl:hidden bg-white/98 border-b border-slate-200 px-4 pt-4 pb-6 mt-3 space-y-3 shadow-2xl backdrop-blur-xl">
          ...
          <div className="grid grid-cols-1 gap-1">
            {navLinks.map((link) => (
              <a
                ...
                className="flex items-center justify-between px-3 py-2.5 text-sm font-medium text-slate-800 hover:bg-white hover:text-cyan-600 rounded-lg transition-colors"
              >
          ...
          <div className="pt-3 border-t border-slate-200/80 flex flex-col gap-2.5">
            {onOpenSlideDeck && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg bg-cyan-950/40 border border-cyan-500/40 text-xs font-semibold text-cyan-700"
              >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg bg-white border border-slate-200 text-xs font-semibold text-slate-800"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg bg-white border border-cyan-500/40 text-xs font-semibold text-cyan-700"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg bg-white/90 border border-slate-200 text-xs font-semibold text-cyan-700 hover:bg-slate-100"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg bg-gradient-to-r from-cyan-600 to-blue-600 text-slate-950 text-xs font-bold shadow-lg shadow-cyan-500/20"
            >
            ...
            <div className="pt-2 flex items-center justify-center gap-3">
              <span className="text-[11px] text-slate-500">Media Sosial:</span>
              <a
                href={COMPANY_INFO.socialMedia.facebook.url}
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg bg-white border border-slate-200 text-blue-600 hover:bg-blue-600/10"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg bg-white border border-slate-200 text-pink-400 hover:bg-pink-600/10"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg bg-white border border-slate-200 text-cyan-700 hover:bg-cyan-600/10"
